...
def edit_appointment():
    if request.method == 'POST':
        ...
        edited_first_name = request.form.get('edited_first_name')
        edited_last_name = request.form.get('edited_last_name')
        edited_location = request.form.get('edited_location')
        edited_appointment_time = request.form.get('edited_appointment_time')
